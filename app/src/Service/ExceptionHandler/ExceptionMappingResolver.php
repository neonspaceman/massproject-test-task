...
class ExceptionMappingResolver
{
    ...
    public function __construct(array $mappings)
    {
        foreach ($mappings as $class => $mapping){
            ...
            $this->addMapping($class, $mapping['code'], $mapping['hidden'] ?? true);
        }
    }
    ...
    private function addMapping(string $class, int $code, bool $hidden): void
    {
        $this->mappings[$class] = new ExceptionMapping($code, $hidden);
    }
}
